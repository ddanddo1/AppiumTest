...
async function runTest() {
  ...
  try {
    ...
    // 사진 촬영 시작
    await clickItem (driver, '//GLButton[@content-desc="NONE" and @text="셔터"]')
    ...
    // 동영상 촬영 시작 및 종료
    await clickItem (driver, '//GLButton[@content-desc="NONE" and @text="녹화"]');
    // 10초 대기
    await driver.pause(10000);
    await clickItem (driver, '//GLButton[@content-desc="NONE" and @text="중지"]');
    ...
    // 카카오 프로필 단일 전송
    await clickItem(driver,'(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[3]');
    ...
    */
    ...
    //뮤직 선택하기
    await clickItem(driver, '(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[5]');
    const textField13 = await driver.$('//android.widget.EditText[@resource-id="search__word"]');
    await textField13.setValue("Hype boy") ;
    await clickItem(driver, '//android.widget.Button[@text="찾기"]');
