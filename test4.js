...
async function runTest() {
  ...
  try {
    ...
    // 사진 촬영 시작
    await clickElement(driver, '//android.view.View[@resource-id="com.sec.android.app.camera:id/bottom_background"]');
    ...
    await clickElement(driver, '//android.widget.ImageButton[@content-desc="녹화 중지"]');
    ...
    // 캡처 선택하기
    await clickElement(driver, '(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[9]');
    ...
    // 음성메시지 선택
    await clickElement(driver, '(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[10]');
    ...
    // 카카오 프로필 단일 전송
    await clickElement(driver, '(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[11]');
    ...
    // 파일 선택하기
    await clickElement(driver, '(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[12]');

    // 파일에서 선택 후 항목 1 전송
    await clickElement(driver, '//*[@text="파일에서 선택"]');
    await clickElement(driver, '(//android.widget.LinearLayout[@resource-id="com.google.android.documentsui:id/item_root"])[1]/android.widget.LinearLayout');
    await clickElement(driver, '(//android.widget.ImageView[@resource-id="com.kakao.talk:id/iv_icon"])[12]');
